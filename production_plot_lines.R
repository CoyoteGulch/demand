...
# Author: John Orr
# Plot dfinal data
# This program plots the production data from dfinal.csv in lines. Each line
# represents a year in a different color.
# 
library(ggplot2)
library(scales)
#
...
# create the plot
p <- ggplot(dfinal) + 
  geom_line(aes(x = Month_Day, y = `2010`, color = "2010")) + 
  geom_line(aes(x = Month_Day, y = `2011`, color = "2011")) + 
  geom_line(aes(x = Month_Day, y = `2012`, color = "2012")) + 
  geom_line(aes(x = Month_Day, y = `2013`, color = "2013")) + 
  geom_line(aes(x = Month_Day, y = `2014`, color = "2014")) + 
  geom_line(aes(x = Month_Day, y = `2015`, color = "2015")) + 
  geom_line(aes(x = Month_Day, y = `2016`, color = "2016")) + 
  geom_line(aes(x = Month_Day, y = `2017`, color = "2017")) + 
  geom_line(aes(x = Month_Day, y = `2018`, color = "2018")) + 
  geom_line(aes(x = Month_Day, y = `2019`, color = "2019")) + 
...
print(p)
#
# End of production_plot_lines.R